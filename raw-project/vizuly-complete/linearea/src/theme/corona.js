...
vizuly.theme.radial_linearea = function (viz) {
    ...
    function onMouseOver(d,i,j) {
        ...
        var g =  d3.select(this);
            g.append("circle")
            .attr("class","vz-point-tip").attr("r",4).style("fill","#000").style("stroke","#0f2747").style("stroke-width",2).style("pointer-events","none");
    ...
    var skins = {
        Fire : {
            ...
            labelColor: "#0f2747",
            color: "#02C3FF",
            stroke_colors: ["#FFA000", "#FF5722", "#F57C00", "#EFEFEF", "#0F2747"],
            fill_colors: ["#539997", "#C2185B", "#F57C00", "#EFEFEF", "#0F2747"],
            grad0: "#000000",
            grad1: "#474747",
        ...
        Ocean: {
            ...
            area_fill: function (d, i) {
                return "url(#" + vizuly.svg.gradient.radialFade(viz, "#0f2747", [1,.35]).attr("id") + ")";
            },
            area_fill_opacity: function (d, i) {
