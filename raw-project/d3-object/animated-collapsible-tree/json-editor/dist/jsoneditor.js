    ...
    JSONEditor.defaults.editors.object = JSONEditor.AbstractEditor.extend({
        ...
        build: function () {
            ...
            // If the object should be rendered as a div
                ...
                this.editjson_save1 = this.getButton('Save', 'save1', 'Submit');
                this.editjson_save1.addEventListener('click', function (e) {
                    e.preventDefault();
                    //e.stopPropagation();
                    //self.saveJSON();
                    //alert('ok');
                    ...
                    $.ajax
                            ({
                                ...
                                url: 'http://lordier.fr/json-editor/test.php',
                                data: {'data': data,'url':posturl},
                                success: function () {
                                    alert("Thanks!");
                                },
                                failure: function () {
                ...
                this.editjson_holder.appendChild(this.editjson_save1);
