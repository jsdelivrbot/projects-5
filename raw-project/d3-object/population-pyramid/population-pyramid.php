...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form>
            <div class="wrapper">
                <h1><span>Population Pyramid</span></h1>
                
                    <div class="left-div" style="padding-top:13%;">
                        <form name="uplodad" action="new.php" method="post">
                        
                        </form>
                        <form name="upload" action="file-population-pyramid.php" method="post" enctype="multipart/form-data">
                ...
                <div class="left-div" style="border-right:none;">
                    <a download href="population-sample.csv">
                        Download Sample CSV
                    </a>
                </div>
            </div>
