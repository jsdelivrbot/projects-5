...
var overlay = new function() {
	...
	this.init = function() {
        ...
        //var g1 = svg.append("g")
         //   .attr("transform", "translate("+(translate.x+60)+", "+(translate.y+60)+")");
    ...
    //var cr1 = frameMapFactory(keyframes);
...
var LobbyingDataVis = function(selector) {
	...
	var getNumbers = function(pane) {
		var moneyFor = pane.find(".moneyFor .lobbyingSum");
		var moneyAgainst = pane.find(".moneyAgainst .lobbyingSum");
