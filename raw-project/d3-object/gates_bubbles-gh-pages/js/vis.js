            ...
            this.data.forEach((function (_this) {
                ...
                return function (e) {
                    ...
                    for (i = 0; i < keys.length; i++) {
                        ...
                        node['radius'] = _this.radius_scale(parseInt(values[3]));
...
//          node = {
//            id: e.id,
//            radius: _this.radius_scale(parseInt(e.total_amount)),
...
//          return _this.nodes.push(node);
            ...
            return (function (_this) {
                return function (d) {
                   var keys = Object.values(d);
                    //alert(keys[8]);
                    var target;
                    target = _this.year_centers[keys[11]];
        ...
        BubbleChart.prototype.show_details = function (data, i, element) {
            ...
            content = "<span class=\"name\">Title:</span><span class=\"value\"> " + keys[0] + "</span><br/>";
            content += "<span class=\"name\">Amount:</span><span class=\"value\"> $" + (addCommas(keys[6])) + "</span><br/>";
            content += "<span class=\"name\">Year:</span><span class=\"value\"> " + keys[11] + "</span>";
            content += "<span class=\"name\">Org:</span><span class=\"value\"> " + keys[5] + "</span>";
