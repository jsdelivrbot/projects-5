                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <div class="inner-spacer">
                                            <div class="flotchart-container" style="width: 100%; text-align: center;">
                                                <div id="placeholder5" class="flotchart-placeholder" style=""></div>
                                            </div>
                                        </div>
                        ...
                        $('#search').keyup(function() {
                            ...
                            $.each(lines, function(key, val) {
                                ...
                                if ((test[1].search(regex) != -1)) {
                                    ...
                                    output += '<li onClick="selectCountry(' + str + ','+tickerArg+')"> ' + test[1] + ' </li>';
                ...
                <script type="text/javascript">
                    function ShowDitails() {
                        ...
                        for (var i = 0; i < newNumberOfComp; i++) {
                            ...
                            outputStep3 += '<tr id="' + i + '"><td>' + test + '</td><td><input type="range" id ="range'+i+'" name="" step="10" value="'+Math.round((100 * newInvArr[i]) / newTotalAmount)+'"></td><td class="percentagesStep3">' + Math.round((100 * newInvArr[i]) / newTotalAmount) + '%' + '</td><td style="text-align: center;"><button class="btn btn-xs btn-danger"><i class="fa fa-remove"></i></button></td></tr>';
