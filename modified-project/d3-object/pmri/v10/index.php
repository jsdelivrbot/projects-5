                               ...
                               <!--  <div class="row" style=" /*padding-left: 100px;*/ ">
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                    ...
                                                    <div style="float:left; width:100%;">
                                                        <div class="row">
                                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                                ...
                                                                <div class="col-sm-4 col-md-4 col-lg-4" style="text-align: left; margin-left: -30px;">
                                        ...
                                        <div class="col-sm-7 col-md-7 col-lg-7">
                                            <div class="row">
                                                <div class="col-sm-6 col-md-6 col-lg-6">
                                                    <h3 style="text-align: center;">Original Portfolio</h3>
                                                </div>
                                                <div class="col-sm-6 col-md-6 col-lg-6">
                                                    <h3 style="text-align: center;">Proposed Portfolio</h3>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                     <p id="changeOnclick"><b></b></p> 
                                                </div>
                                        ...
                                        <div id="Summary" class="tabcontent" style="display:block; ">
                                            <div class="wrapper">
                                                ...
                                                <center>
                                                    ...
                                                    <svg id="ms" width="1020" height="400" style="font-family: 'graph', serif;">
                                                </svg>
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        ...
                        if ($('#basicAdvance').is(":checked")) {
                            ...
                            flag = 0;
                            $('#changeOnclick').html("");
                             $('#changeOnclick').html("<h5>DARKER IS BETTER</h5>");
                            ...
                            $('#changeOnclick').html("<h5>BLACK = BETTER THAN BENCHMARK</h5>");
                            $('#changeOnclick').css("text-align","center");
                        }
                ...
                <script type="text/javascript">
                    function ShowDitails() {
                        ...
                        for(var j = 1;j < col3.length-1; j++){
                            ...
                            if (flag != 1 && heading[j] != "") {
                                advViewTable += '<tr ><td rowspan="'+rowSpan[headIndex]+'" style="width: 135px; text-align: center; background: #858689; color: #fff;">'+heading[j]+'</td><td style="text-align: center; width: 30px;"><button class="btn btn-xs btn-danger"   onclick="delete()" style="color: #D24D33; background: #fff;">X</button></td><td style="width: 245px;">'+col3[j]+'</td><td style="width: 80px;">'+yearPars[j]+'</td><td style="padding: 17px; background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td ><td style="border: none;"></td><td style="padding: 17px; background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td></tr>';
                                    
                                    headIndex += 1;
                            } else if(flag != 0 && heading[j] != "") {
                                advViewTable += '<tr ><td rowspan="'+rowSpan[headIndex]+'" style="width: 135px; text-align: center; background: #858689; color: #fff;">'+heading[j]+'</td><td style="text-align: center; width: 30px;"><button class="btn btn-xs btn-danger"   onclick="delete()" style="color: #D24D33; background: #fff;">X</button></td><td style="width: 245px;">'+col3[j]+'</td><td style="width: 80px;">'+yearPars[j]+'</td><td style="padding: 17px; background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="border: none;"></td><td style="padding: 17px; background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td></tr>';
                            ...
                            // else if(flag != 1 && heading[j] != ""){
                            //     advViewTable += '<tr ><td style="background: #858689; text-align: left; border-right: none; color: #fff;"><b>'+heading[j]+'</b></td><td colspan="3" style="background: #858689; border-left: none;"></td><td colspan="17" style="border: none;"></td></tr>';
                            // }
                            // else if(flag != 0 && heading[j] != ""){
                            //     advViewTable += '<tr ><td style="background: #858689; text-align: left; border-right: none; color: #fff;"><b>'+heading[j]+'</b></td><td colspan="3" style="background: #858689; border-left: none;"></td><td colspan="17" style="border: none;"></td></tr>';
                            // }
                         ...
                         if (flag != 1) {
                                advViewTable += '<tr ><td colspan="4" style="text-align: left;"><b>Overall grade</b></td><td style="padding: 17px; background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td ><td style="border: none;"></td><td style="padding: 17px; background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + color[Math.floor(Math.random() * 5)] + '"></td></tr>';
                            } else {
                                advViewTable += '<tr ><td colspan="4" style="text-align: left;"><b>Overall grade</b></td><td style="padding: 17px; background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="border: none;"></td><td style="padding: 17px; background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td><td style="background-color: ' + colorOriginal[Math.floor(Math.random() * 5)] + '"></td></tr>';
                            }
