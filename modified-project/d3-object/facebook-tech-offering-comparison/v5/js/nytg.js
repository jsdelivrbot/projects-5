...
"trydom" != window.location.hash && "#trydom" != window.location.hash || (USE_CANVAS = !1), nytg.Chart = function() {
    ...
    if (!c) {
        ...
        for (var e = new Date(1998, 1, 0), f = d3.max(d, function(a) {
                return a.date
        ...
        if (USE_CANVAS) {
            ...
            var F = $jq("<div>").addClass("nytg-popup").hide().appendTo("body"),
                ...
                M = function(a) {
                    ...
                    return e = a ? e + "<div class='nytg-popup-line'><span class='nytg-popup-label'>Value at I.P.O.</span><br/><span class='nytg-popup-value'>$104 billion</span></div>" : e + ("<div class='nytg-popup-line'><span class='nytg-popup-value'>" + ra + "</span> <span class='nytg-popup-label'>Return on Equity of:</span></div>") + "<table>" + ("<tr><td class='row1'><span class='nytg-popup-label'>Payout Ratio of:</span>" + rb + "%</td></tr>") + ("</table>")
                };
        ...
        return USE_CANVAS ? Q() : v.selectAll(".company").data(d).enter().append("div").attr("class", "company").style("background", function(a) {
            ...
            set: function(a) {
                ...
                if (O(), "preFacebook" === a) {
                    var d = "appreciation";
                    if (c || (B.scale(i).tickValues([0, 2, 4, 6, 8]), i.domain([0, 10]), b.select(".y.axis").call(B)), USE_CANVAS) S(d);
                    else {
                ...
                } else "facebook" === a ? (d = "appreciation", c || (B.scale(i).tickValues([0, 5, 10, 15]), i.domain([0, 20]), b.select(".y.axis").call(B)), USE_CANVAS ? S(d) : (e = u.transition().duration(2e3), e.selectAll(".company").style("left", function(a) {
                    return p(a, d)
                }).style("top", function(a) {
                    return q(a, d)
                }).style("width", function(a) {
                    ...
                    return o(a[d])
                }))) : "log" === a ? (d = "appreciation", c || (B.scale(i).tickValues([0, 5, 10, 15, 20, 25]), i.domain([0, 30]), b.select(".y.axis").call(B)), USE_CANVAS ? S(d) : (e = u.transition().duration(2e3), e.selectAll(".company").style("left", function(a) {
                    return p(a, d)
                }).style("top", function(a) {
                    return r(a, d)
                }).style("width", function(a) {
                    ...
                    return o(a[d])
                })), b.select(".y.axis").call(B)) : "pop" === a ? (d = "appreciation", c || (B.scale(i).tickValues([0, 10, 20, 30, 35]), i.domain([0, 40]), b.select(".y.axis").call(B)), USE_CANVAS ? S(d) : (e = u.transition().duration(2e3), e.selectAll(".company").style("left", function(a) {
                    return p(a, d)
                }).style("top", function(a) {
                    return r(a, d)
                }).style("width", function(a) {
                    ...
                    return o(a[d])
                })), b.select(".y.axis").call(B)) : "threeYear" === a && (d = "appreciation", c || (B.scale(i).tickValues([0, 10, 20, 30, 40, 50]), i.domain([0, 50]), b.select(".y.axis").call(B)), USE_CANVAS ? S(d) : (e = u.transition().duration(2e3), e.selectAll(".company").style("left", function(a) {
                    return p(a, d)
                }).style("top", function(a) {
                    return r(a, d)
                }).style("width", function(a) {
