            ...
            var F = $jq("<div>").addClass("nytg-popup").hide().appendTo("body"),
                ...
                M = function(a) {
                    ...
                    var b = "$" + (10 > b ? L(b) : K(b)),
                       ...
                       e = "<div class='nytg-popup-label'>Run began in " + e + "</div>" + ("<div class='nytg-popup-title'>" + h + "</div>");
                    return e = a ? e + "<div class='nytg-popup-line'><span class='nytg-popup-label'>Value at I.P.O.</span><br/><span class='nytg-popup-value'>$104 billion</span> </div>" : e + ("<div class='nytg-popup-line'><span class='nytg-popup-value'>" + ra + "</span> <span class='nytg-popup-label'>Year run drove total return of:</span><strong>" + rb + "%</strong></div>")
                };
        ...
        return USE_CANVAS ? Q() : v.selectAll(".company").data(d).enter().append("div").attr("class", "company").style("background", function(a) {
            ...
            set: function(a) {
                ...
                if (O(), "preFacebook" === a) {
                    ...
                    return o(a[d])
                }))) : "log" === a ? (d = "appreciation", c || (B.scale(i).tickValues([1000, 1500, 2000, 2500]), i.domain([1000, 3000]), b.select(".y.axis").call(B)), USE_CANVAS ? S(d) : (e = u.transition().duration(2e3), e.selectAll(".company").style("left", function(a) {
                    return p(a, d)
                }).style("top", function(a) {
                    return r(a, d)
                }).style("width", function(a) {
