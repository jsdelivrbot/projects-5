...
"trydom" != window.location.hash && "#trydom" != window.location.hash || (USE_CANVAS = !1), nytg.Chart = function() {
    ...
    if (!c) {
        ...
        return USE_CANVAS ? Q() : v.selectAll(".company").data(d).enter().append("div").attr("class", "company").style("background", function(a) {
            ...
            d: d,
            set: function(a) {
                var b = w.transition().duration(3e3).each("end", function() {
                    N(a)
                });
                if (O(), "preFacebook" === a) {
                    var d = "appreciation";
                    if (c || (B.scale(i).tickValues([0, 5e3, 1e4, 15e3, 2e4, 25e3]), i.domain([0, 34e3]), b.select(".y.axis").call(B)), USE_CANVAS) S(d);
                    else {
                ...
                } else "facebook" === a ? (d = "appreciation", c || (B.scale(i).tickValues([2e4, 4e4, 6e4, 8e4, 1e5]), i.domain([0, 127e3]), b.select(".y.axis").call(B)), USE_CANVAS ? S(d) : (e = u.transition().duration(2e3), e.selectAll(".company").style("left", function(a) {
                    return p(a, d)
                }).style("top", function(a) {
                    return q(a, d)
                }).style("width", function(a) {
                    ...
                    return o(a[d])
                }))) : "log" === a ? (d = "appreciation", B.scale(j).tickValues([100, 1e3, 1e4, 1e5]), USE_CANVAS ? S(d, !0) : (e = u.transition().duration(2e3), e.selectAll(".company").style("left", function(a) {
                    return p(a, d)
                }).style("top", function(a) {
                    return r(a, d)
                }).style("width", function(a) {
                    ...
                    return o(a[d])
                })), b.select(".y.axis").call(B)) : "pop" === a ? (d = "run", B.scale(j).tickValues([10, 100, 1e3, 1e4, 1e5]), USE_CANVAS ? S(d, !0) : (e = u.transition().duration(2e3), e.selectAll(".company").style("left", function(a) {
                    return p(a, d)
                }).style("top", function(a) {
                    return r(a, d)
                }).style("width", function(a) {
                    ...
                    return o(a[d])
                })), b.select(".y.axis").call(B)) : "threeYear" === a && (d = "threeYear", B.scale(j).tickValues([10, 100, 1e3, 1e4, 1e5]), USE_CANVAS ? S(d, !0) : (e = u.transition().duration(2e3), e.selectAll(".company").style("left", function(a) {
                    return p(a, d)
                }).style("top", function(a) {
                    return r(a, d)
                }).style("width", function(a) {
