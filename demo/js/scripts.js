...
(function ($) {
    ...
    if ($('.ui-slider3').length) {
        ...
        if ($('#powerwidgets_1').length) {
            $('#powerwidgets_1').powerWidgets({
                grid: '.bootstrap-grid',
                widgets: '.powerwidget',
        ...
        if ($('#powerwidgets_2').length) {
            $('#powerwidgets_2').powerWidgets({
                grid: '.bootstrap-grid',
                widgets: '.powerwidget',
