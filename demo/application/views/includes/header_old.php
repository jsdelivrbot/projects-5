...
<title>Habitmod</title>
<link rel="shortcut icon" type="image/x-icon" href="<?= base_url('images/favicon.ico.png'); ?>" />
...
<script type="text/javascript" src="http://res.cloudinary.com/csemahadi/raw/upload/v1430030493/modernizr.custom_vaaqtg.js"></script>
<!--script type="text/javascript" src="<?= base_url('css/font-awesome.css') ?>"></script-->
</head>
<body>
